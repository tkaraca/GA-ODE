...
nvars = 3;  LB = [5 0.5 0.1]; UB=[15 15 2];
...
SONUC1=squeeze(SONUC(1,:,:));% 1. run daki son sonuc u getirir
SONUC2=squeeze(SONUC(2,:,:));% 2. run daki son sonuc u getirir
SONUC3=squeeze(SONUC(3,:,:));% 1. run daki son sonuc u getirir
SONUC4=squeeze(SONUC(4,:,:));% 1. run daki son sonuc u getirir
SONUC5=squeeze(SONUC(5,:,:));% 1. run daki son sonuc u getirir
SONUC6=squeeze(SONUC(6,:,:));% 1. run daki son sonuc u getirir
SONUC7=squeeze(SONUC(7,:,:));% 1. run daki son sonuc u getirir
SONUC8=squeeze(SONUC(8,:,:));% 1. run daki son sonuc u getirir
SONUC9=squeeze(SONUC(9,:,:));% 1. run daki son sonuc u getirir
SONUC10=squeeze(SONUC(10,:,:));% 1. run daki son sonuc u getirir
...
plot(alpha,SONUC8(:,1),'*');
plot(alpha,SONUC9(:,1),'*');
plot(alpha,SONUC10(:,1),'*');
title('t1'),xlabel('alpha'),ylabel('Weeks')
...
plot(alpha,SONUC8(:,2),'*');
plot(alpha,SONUC9(:,2),'*');
plot(alpha,SONUC10(:,2),'*');
title('Delta_t'),xlabel('alpha'),ylabel('Weeks')
...
plot(alpha,SONUC8(:,3),'*');
plot(alpha,SONUC9(:,3),'*');
plot(alpha,SONUC10(:,3),'*');
title('nu'),xlabel('alpha'),ylabel('Rate')
...
plot(alpha,SONUC8(:,4),'*');
plot(alpha,SONUC9(:,4),'*');
plot(alpha,SONUC10(:,4),'*');


title('Cost'),xlabel('alpha'),ylabel('Relative Cost')

save('sonuc150.mat','SONUC')
squeeze(SONUC(1,:,:))
1
pause
